        ...
        <div class="category-section">
            ...
            <div class="menu-grid">
                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="menu-card">
                        <div class="card-image" onclick="openModal('<?php echo e($m->id); ?>', '<?php echo e($m->nama); ?>', '<?php echo e($m->harga); ?>')">
                        ...
                        <div class="card-content">
                            ...
                            <div class="action-group">
                                <button class="btn-info-detail" onclick="showDetail('<?php echo e($m->id); ?>')">DETAIL</button>
                                <button class="btn-order" onclick="openModal('<?php echo e($m->id); ?>', '<?php echo e($m->nama); ?>', '<?php echo e($m->harga); ?>')">PESAN</button>
                            </div>
                        </div>
                    </div>
    ...
    <form action="<?php echo e(route('transaksi.store')); ?>" method="POST" style="margin-top: 20px;">
        ...
        <select name="id_meja" required class="input-minimal">
            ...
            <?php $__currentLoopData = $mejas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meja): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($meja->id); ?>" <?php echo e($meja->status ? '' : 'disabled'); ?>>
                    Meja <?php echo e($meja->nomor_meja); ?> <?php echo e($meja->status ? '' : '(Penuh)'); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('kasir.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\restoran\resources\views/kasir/menu.blade.php ENDPATH**/ ?>