...
<body>
    ...
    <div class="struk-container">
        ...
        <div>
            <div class="info-row"><span>No. Transaksi</span><span style="font-weight:bold">#<?php echo e($transaksi->id); ?></span></div>
            <div class="info-row"><span>Tanggal</span><span><?php echo e(date('d/m/Y H:i', strtotime($transaksi->tanggal))); ?></span></div>
            <div class="info-row"><span>Kasir</span><span><?php echo e($transaksi->nama_kasir ?? 'System'); ?></span></div>
            <div class="info-row"><span>Pelanggan</span><span><?php echo e($transaksi->nama_bersih); ?></span></div>
            <div class="info-row"><span>Tipe Pesanan</span><span><?php echo e($transaksi->id_meja ? 'Dine In (Meja '.$transaksi->nomor_meja.')' : 'Takeaway'); ?></span></div>
        </div>
        ...
        <div style="min-height: 100px;">
            ...
            <div class="item-container">
                <span class="item-name"><?php echo e($item->nama_menu); ?></span>
                <div class="item-details">
                    <span><?php echo e($item->jumlah); ?> x <?php echo e(number_format($item->harga_satuan, 0, ',', '.')); ?></span>
                    <span style="font-weight:bold"><?php echo e(number_format($item->subtotal, 0, ',', '.')); ?></span>
                </div>
                <div class="item-meta">
                    <span>[<?php echo e(strtoupper($item->metode ?? 'Dine In')); ?>]</span>
                </div>
                <?php if(!empty($item->catatan)): ?>
                <div class="item-note">Catatan: <?php echo e($item->catatan); ?></div>
                <?php endif; ?>
            </div>
        ...
        <div class="total-section">
            <div class="flex-between grand-total">
                ...
                <span>Rp <?php echo e(number_format($transaksi->total_bayar, 0, ',', '.')); ?></span>
            </div>
            <div style="margin-top: 10px;">
                <div class="flex-between">
                    <span>Status Bayar</span>
                    <span style="font-weight:bold; border: 1px solid #000; padding: 2px 5px;"><?php echo e(strtoupper($transaksi->status)); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="btn-group">
            ...
            <form action="<?php echo e(route('transaksi.tambah', $transaksi->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
            ...
            <a href="<?php echo e(route('kasir.transaksi')); ?>" class="btn-back">Kembali ke Daftar</a>
        </div>
    </div>
</body>
</html><?php /**PATH C:\xampp\htdocs\restoran\resources\views/kasir/detailtransaksi.blade.php ENDPATH**/ ?>