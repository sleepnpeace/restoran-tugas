        ...
        <table style="width: 100%; border-collapse: collapse; text-align: left;">
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid #f1f5f9;">
                    <td style="padding: 15px;"><b><?php echo e($displayName); ?></b><br><small><?php echo e(date('d M Y H:i', strtotime($t->tanggal))); ?></small></td>
                    <td style="padding: 15px;">
                        <?php echo e($t->nomor_meja ? 'Meja ' . $t->nomor_meja : 'Takeaway'); ?>

                    </td>
                    <td style="padding: 15px; font-weight: 800; color: #16a34a;">Rp <?php echo e(number_format($t->total_bayar, 0, ',', '.')); ?></td>
                    <td style="padding: 15px;">
                        <span style="padding: 5px 12px; border-radius: 20px; font-size: 11px; font-weight: 800; 
                            background: <?php echo e($t->status == 'paid' ? '#f0fdf4' : ($t->status == 'cancel' ? '#fef2f2' : '#fff7ed')); ?>; 
                            color: <?php echo e($t->status == 'paid' ? '#16a34a' : ($t->status == 'cancel' ? '#dc2626' : '#ea580c')); ?>">
                    ...
                    <td style="padding: 15px;">
                        <div style="display: flex; gap: 5px;">
                            ...
                            <button onclick="openPaymentModal('<?php echo e($t->id); ?>', '<?php echo e($t->total_bayar); ?>')" 
                            ...
                            <a href="<?php echo e(route('kasir.detailtransaksi', $t->id)); ?>" target="_blank"
...
<script>
   function openPaymentModal(id, total) {
    const actionUrl = "<?php echo e(url('/kasir/transaksi/bayar')); ?>/" + id;
...
<?php echo $__env->make('manager.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\restoran\resources\views/transaksi/index.blade.php ENDPATH**/ ?>